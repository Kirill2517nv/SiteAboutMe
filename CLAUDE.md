...
- **Шкала кегля – восемь ступеней, других размеров в проекте нет.** Роль решает
  ...
  | **h1 лендинга** (главные учебника, спецкурса, ЕГЭ, уроков, «Обо мне») | `text-3xl sm:text-4xl` | 30 → 36 |

  Крупнее 36px – только display-цифры (балл прогноза, номера заданий на карте,
